...
# то же самое одной фразой — показывается один раз, в подзаголовке архетипа,
# а не в каждом билде: внутри группы это всё равно у всех одинаково
ARCH_FEEL = {
 'Arch-Militant': 'Чем дольше тянется бой, тем больнее ты бьёшь. Самый неприхотливый стиль: ни расстановки, ни комбо не требует.',
 'Assassin': 'Весь урон уходит в одну цель — она обычно не доживает до своего хода. Нужна аккуратная позиция, по площади не работаешь.',
 'Vanguard': 'Стоишь в самой гуще, стягиваешь внимание и почти не падаешь. Урона немного, зато отряд за спиной цел.',
 'Master Tactician': 'Главный ресурс не твой урон, а лишние ходы для союзников. Играешь диспетчером: сам жмёшь мало, бьют остальные.',
 'Grand Strategist': 'Расставляешь зоны и держишь в них весь отряд. Бой выигрывается расстановкой ещё до первого выстрела.',
 'Bounty Hunter': 'Метишь цель, добиваешь и за убийство возвращаешь себе ход. Бой идёт волнами: убил — снова твой ход.',
 'Executioner': 'Вешаешь кровотечения и яды: урон капает сам, пока ты бьёшь следующего. Мгновенного взрыва нет, зато к третьему ходу поле тает.',
 'Overseer': 'Рядом питомец, и половина действий — команды ему. Решений за ход больше, зато отряд получает и урон, и поддержку.',
}
